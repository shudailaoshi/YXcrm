...
import com.YXcrm.service.impl.LogstuServiceImpl;
import com.YXcrm.utility.M_msg;
import com.YXcrm.utility.T_DataControl;
import com.YXcrm.utility.T_DataMap2Bean;
import com.google.gson.Gson;

public class LogstuController extends HttpServlet {
	LogstuService lgs = new LogstuServiceImpl();
	BackResult backResult = new BackResult("信息值：默认","请求值：默认",null);
	  ...
	  protected void doPost(HttpServletRequest request, HttpServletResponse response)
	    ...
	    if (qqiu.equals("test") || qqiu.equals("add") || qqiu.equals("delete") || qqiu.equals("edit")
	      ...
	      if (str != null && str != "" && str.length() != 0) { // 非空判断，防止前台传空报500服务器错误中的空指针
	        ...
	        logstu = t_map2bean.MapToLogstu(map);
	      } else {
	      ...
	      // TODO 待完成
	      ArrayList<Logstu> resultList = lgs.getList();
	  ...
	  private void qqiuChoice(String qqiu, Logstu logstu,List<String> uuidList) {
	    ...
	    if (delete) {
	      String result = lgs.delete(logstu.getUuid());
	      ArrayList<String> resultList = new ArrayList<String>();
	      resultList.add(result);
	      backResult.setMessage("信息值：成功");
	      backResult.setQingqiu("学员日志信息删除" + logstu.getUuid());
	      backResult.setData(resultList);
	    }
	    if (edit) {
	    ...
	    if (deleteBatch) {
			String result = lgs.deleteBatch(uuidList);
